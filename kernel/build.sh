...
gcc -c dev/OHCI.c -m32 -o ohci.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra || exit
...
gcc -T linker.ld -o myos.bin -m32 -ffreestanding -O2 -nostdlib boot.o kernel.o io_ports.o interrupts.o com_port.o ide.o pci.o memory.o timer.o video.o videoasm.o isr.o ps2.o device.o iso9660.o elf.o vbox.o xhci.o acpi.o ahci.o ehci.o uhci.o ohci.o || exit
